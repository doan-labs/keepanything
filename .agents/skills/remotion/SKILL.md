---
name: remotion
description: Making Remotion videos — creating compositions, React markup and animation, timing and sequencing, transitions, fonts, audio, captions, maps, multimedia, Studio, rendering and export, upgrades, and Remotion-powered apps. Use for any work under video/.
version: 4.0.522
---
